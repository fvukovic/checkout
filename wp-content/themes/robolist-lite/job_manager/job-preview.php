            ...
            <div class="details-container">
                ...
                <div class="listing-content section">
                    ...
                    <div class="detail-wrapper">
                        ...
                        <div class="detail-label">ANGEBOT/PREISile</div>
        ...
        <div class="container">
            <div class="job_listing_preview_title">
                ...
                if ($formRole == "premium" && $user->membership_level->name != "Premium") { ?>
                    ...
                    <input type="button" onclick="window.location='/checkout?id=<?php echo $post->ID; ?> '" name="next" id="job_preview_submit_button" class="button job-manager-button-submit-listing" value="Next" />
                <?php } else {  ?>
