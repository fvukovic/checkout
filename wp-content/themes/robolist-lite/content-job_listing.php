...
?>
	...
	<?php echo '<a href="' . esc_url(get_the_permalink()) . '" class="link-detail-page">'; ?>
            <div class="listing-content-wrap">
                ...
                <div class="listing-thumb <?php if(isset($address)){ echo 'premium';}?>"  style="background-image:url(<?php echo esc_url($pieces[0]); ?>)">
                <? if(isset($address)){ echo '<span class="premium-note"> Premium</span>';}
